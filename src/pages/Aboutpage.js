		...
		<Container className={classes.container}>
			<div>
				<Typography variant='subtitle1'>
					...
					become a programmer.
					<br /> <br />I have a great passion for learning and building
					projects. I'm focused, driven and I would love an opportunity to learn
					and grow not just as a developer but as a person.
					<br />
					Thanks for reading!
